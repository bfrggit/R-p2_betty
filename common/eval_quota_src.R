...
dimnames(objective_general_history)[[1]] = data_quota
...
dimnames(objective_x_history)[[1]] = data_quota
...
dimnames(proc_t_general_history)[[1]] = data_quota
...
for(pnd in 1L:num_loops) {
    ...
    for(rnd in 1L:num_rounds) {
        ...
        cat(
            ...
            sprintf("data_quota = %d", data_quota[rnd]),
            "\n"
        )
