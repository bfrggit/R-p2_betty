...
par_sparse = as.integer(args[1])
par_modulo = as.integer(args[2])
par_legend = as.numeric(args[3])
stopifnot(par_sparse == as.numeric(args[1]))
stopifnot(par_modulo == as.numeric(args[2]))
