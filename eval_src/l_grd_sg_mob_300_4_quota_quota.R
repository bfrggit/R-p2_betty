...
data_quota_all = as.integer(2 ** seq(16, 23, by = 1 / 3)) # length = 22
stopifnot(length(data_quota_all) >= x_case)

data_quota = data_quota_all[x_case]
...
out_path = "eval_data/lyap_grd_mob_300_4_quota_quota"
